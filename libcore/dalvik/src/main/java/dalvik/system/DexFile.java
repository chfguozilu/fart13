...
public final class DexFile {
    ...
    /**
     * Starts the ART-side asynchronous record writer. ART duplicates fd; the
     * caller retains ownership of the supplied descriptor.
     *
     * @hide
     */
    private static native boolean beginRuntimeProfile(int fd);

    /**
     * Drains queued records, writes the commit footer, fsyncs and stops the
     * ART writer. Returns false if any part of the output failed.
     *
     * @hide
     */
    private static native boolean endRuntimeProfile();

    /** Enumerates and probes eligible methods declared by target. @hide */
    private static native void visitRuntimeMethods(Class<?> target);
